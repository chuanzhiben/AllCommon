package cn.dayu.slmap.map.tianditu;
...
public class LayerInfoFactory {
    ...
    // WGS84坐标系 温州
    private static final String URL_WZ_VECTOR_WGS84 = "http://www.go577.com/iserver/services/wzmap/wmts";
    private static final String URL_WZ_IMAGE_WGS84 = "http://www.go577.com/iserver/services/imagemap/wmts";
    private static final String URL_WZ_ERWU_WGS84 = "http://www.go577.com/iserver/services/3dmap/wmts";
    // 墨卡托坐标系 全国
    ...
    private static final Point ORIGIN_WGS84 = new Point(-180, 90);
    ...
    private static final double[] SCALES_WZ = {5.916587109E8,
            2.9582935545E8, 1.4791467773E8, 7.395733886E7,
            3.697866943E7, 1.848933472E7, 9244667.36,
            4622333.68, 2311166.84, 1155583.42,
            577791.71, 288895.85, 144447.93,
            72223.96, 36111.98, 18055.99,
            9028.0, 4514.0, 2257.0, 1128.5, 564.25};
    ...
    public static TianDiTuLayerInfo getTLayerInfo(int layerType) {
        ...
        switch (layerType) {
            ...
            case TianDiTuLayerTypes.TIANDITU_VECTOR_ANNOTATION_ENGLISH_2000:
                ...
                break;
            case TianDiTuLayerTypes.TIANDITU_VECTOR_WZ_WGS84:
                layerInfo.setUrl(LayerInfoFactory.URL_WZ_VECTOR_WGS84);
                layerInfo.setLayerName(LayerInfoFactory.LAYER_NAME_VECTOR);
                break;
            case TianDiTuLayerTypes.TIANDITU_IMAGE_WZ_WGS84:
                layerInfo.setUrl(LayerInfoFactory.URL_WZ_IMAGE_WGS84);
                layerInfo.setLayerName(LayerInfoFactory.LAYER_NAME_IMAGE);
                break;
            case TianDiTuLayerTypes.TIANDITU_ERWU_WZ_WGS84:
                layerInfo.setUrl(LayerInfoFactory.URL_WZ_ERWU_WGS84);
                layerInfo.setLayerName(LayerInfoFactory.LAYER_NAME_ERWU);
                break;
        ...
        handleTLayerInfo(layerInfo, layerType);
        return layerInfo;
    }


    private static void handleTLayerInfo(TianDiTuLayerInfo layerInfo,
                                         int layerType) {
        switch (layerType) {
            case TianDiTuLayerTypes.TIANDITU_IMAGE_2000:
            case TianDiTuLayerTypes.TIANDITU_IMAGE_ANNOTATION_CHINESE_2000:
            ...
            case TianDiTuLayerTypes.TIANDITU_IMAGE_WZ_WGS84:
            case TianDiTuLayerTypes.TIANDITU_ERWU_WZ_WGS84:
                layerInfo.setOrigin(LayerInfoFactory.ORIGIN_WGS84);
                layerInfo.setSrid(LayerInfoFactory.SRID_WGS84);
                layerInfo.setxMin(LayerInfoFactory.X_MIN_2000);
                layerInfo.setyMin(LayerInfoFactory.Y_MIN_2000);
                layerInfo.setxMax(LayerInfoFactory.X_MAX_2000);
                layerInfo.setyMax(LayerInfoFactory.Y_MAX_2000);
                layerInfo.setScales(LayerInfoFactory.SCALES_WZ);
                layerInfo.setResolutions(LayerInfoFactory.RESOLUTIONS_2000);
                layerInfo.setTileMatrixSet(LayerInfoFactory.TILE_MATRIX_SET_WZ_WGS84);
                layerInfo.setMaxZoomLevel(20);
                break;
            case TianDiTuLayerTypes.TIANDITU_IMAGE_ANNOTATION_CHINESE_MERCATOR:
            case TianDiTuLayerTypes.TIANDITU_IMAGE_ANNOTATION_ENGLISH_MERCATOR:
            case TianDiTuLayerTypes.TIANDITU_IMAGE_MERCATOR:

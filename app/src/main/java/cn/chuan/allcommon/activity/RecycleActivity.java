...
import cn.chuan.allcommon.view.recycleview.DividerGridItemDecoration;
import cn.chuan.allcommon.view.recycleview.DividerItemDecoration;
import cn.chuan.allcommon.view.recycleview.RvAdapter;
    ...
    private void initData() {
        ...
        rvAdapter.setOnItemClickListener(new RvAdapter.OnItemClickListener() {
            ...
            public void onItemClickListener(int position, Integer data) {
                Toast.makeText(RecycleActivity.this, "点击了" + position, Toast.LENGTH_SHORT).show();
            }

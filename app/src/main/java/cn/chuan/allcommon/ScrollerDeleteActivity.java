...
import cn.chuan.allcommon.adapter.DeleteAdapter;
import cn.chuan.allcommon.until.view.swipdelete.ScrollListviewDelete;

public class ScrollerDeleteActivity extends FragmentActivity implements ScrollListviewDelete.ItemClickListener {

...
public class GlobalDialog extends Dialog {
    ...
    /** 设置左边按钮监听 */
    public GlobalDialog setLeftOnclick(View.OnClickListener listener) {
        left.setOnClickListener(listener);
        return this;
    }

    /** 设置右边按钮监听 */
    public GlobalDialog setRightOnclick(View.OnClickListener listener) {
        right.setOnClickListener(listener);
        return this;
    }

    /** 设置中间按钮监听 */
    public GlobalDialog setMiddleOnclick(View.OnClickListener listener) {
